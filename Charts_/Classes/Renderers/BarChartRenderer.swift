...
//                context.fill(barRect)
                ...
                if dataSet.colorAt(j) != UIColor.white.withAlphaComponent(0.75) && dataSet.entryForIndex(j)?.value != Double(0.0) {
                    context.setLineDash(phase: 2, lengths: [4])
                ...
                case 0:
                    ...
                    break
                case 1:
                    if dataSet.colorAt(j) != UIColor.white.withAlphaComponent(0.75) && Double((dataSet.entryForIndex(j)?.value)!) > (dataSet.entryForIndex(j - 1)?.value)! {
                        
                        context.setStrokeColor(UIColor(red: 133/255.0, green: 132/255.0, blue: 132/255.0, alpha: 1).cgColor);
                        context.stroke(barRect)
